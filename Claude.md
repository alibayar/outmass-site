...
2. **locale-consistency** — 14 locale dosyasında (13 dil; `zh` + `zh_CN` aynı dilin iki dosyası) anahtar eşitliği + $PLACEHOLDER$
...
Kurallar: yeni bir locale anahtarı HER ZAMAN 14 dosyaya birden eklenir (test
