...
REGISTRY: tuple[Var, ...] = (
    ...
    Var("FREE_UPLOAD_ROW_LIMIT", (WEB,), False, "defaults to 250; in force while UPLOAD_LIMIT_FOLLOWS_QUOTA is off"),
    Var("STARTER_UPLOAD_ROW_LIMIT", (WEB,), False, "defaults to 2500; in force while UPLOAD_LIMIT_FOLLOWS_QUOTA is off"),
    Var("PRO_UPLOAD_ROW_LIMIT", (WEB,), False, "defaults to 10000; in force while UPLOAD_LIMIT_FOLLOWS_QUOTA is off"),
    Var("UPLOAD_LIMIT_FOLLOWS_QUOTA", (WEB,), False, "defaults to false; set true the day 0.2.3 publishes on both stores"),
