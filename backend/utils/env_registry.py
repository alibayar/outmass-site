...
REGISTRY: tuple[Var, ...] = (
    ...
    Var("FREE_UPLOAD_ROW_LIMIT", (WEB,), False, "defaults to 250; in force for clients older than 0.2.3, and while UPLOAD_LIMIT_FOLLOWS_QUOTA is off"),
    Var("STARTER_UPLOAD_ROW_LIMIT", (WEB,), False, "defaults to 2500; in force for clients older than 0.2.3, and while UPLOAD_LIMIT_FOLLOWS_QUOTA is off"),
    Var("PRO_UPLOAD_ROW_LIMIT", (WEB,), False, "defaults to 10000; in force for clients older than 0.2.3, and while UPLOAD_LIMIT_FOLLOWS_QUOTA is off"),
    Var("UPLOAD_LIMIT_FOLLOWS_QUOTA", (WEB,), False, 
        "defaults to false, and no longer needs flipping: the client's version decides (0.2.3+ gets the single ceiling). True is a one-directional override that lifts it for older clients too"),
    Var("CSV_UPLOAD_ROW_LIMIT", (WEB,), False, "defaults to 10000; the single ceiling used once the flag is on"),
