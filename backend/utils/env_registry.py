...
REGISTRY: tuple[Var, ...] = (
    ...
    Var("FREE_UPLOAD_ROW_LIMIT", (WEB,), False, "defaults to 250"),
    Var("STARTER_UPLOAD_ROW_LIMIT", (WEB,), False, "defaults to 2500"),
    Var("PRO_UPLOAD_ROW_LIMIT", (WEB,), False, "defaults to 10000"),
