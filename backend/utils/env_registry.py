...
REGISTRY: tuple[Var, ...] = (
    ...
    Var("FREE_UPLOAD_ROW_LIMIT", (WEB,), False, "defaults to 250; in force for clients older than 0.3.0, and while UPLOAD_LIMIT_FOLLOWS_QUOTA is off"),
    Var("STARTER_UPLOAD_ROW_LIMIT", (WEB,), False, "defaults to 2500; in force for clients older than 0.3.0, and while UPLOAD_LIMIT_FOLLOWS_QUOTA is off"),
